  ...
  if (contactForm) {
    ...
    const getErrorMessage = function (field, rule) {
      ...
      const messages = {
        ...
        minLength:
          label + ' must be at least ' + field.dataset.minLength + ' characters.',
      ...
      function (entries, observer) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const children = Array.prototype.slice.call(group.children);
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ZY SKATE CLUB משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'bc45a6ec-bb0e-4b53-b6ec-a8e1a6f54d34',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'bc45a6ec-bb0e-4b53-b6ec-a8e1a6f54d34';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'bc45a6ec-bb0e-4b53-b6ec-a8e1a6f54d34';
